...
class CardWidget(Frame):
    def set_up_card(self, card_tuple, mode=''):
        ...
        if mode == 'dis':
            self.img = PhotoImage(
                file=f'C:\\Users\\Balarubinan\\PycharmProjects\\UNO_game\\src\\UNO_cards\\UNOempty.png')
        else:
    ...
    def decide_file(self):
        ...
        if self.symbol in [str(x) for x in range(100)]:
            return f'C:\\Users\\Balarubinan\\PycharmProjects\\UNO_game\\src\\UNO_cards\\UNO{z}{self.color}.png'
        else:
            print('ee')
            if self.symbol == '+2':
                return f'C:\\Users\\Balarubinan\\PycharmProjects\\UNO_game\\src\\UNO_cards\\UNO{z}{self.color}+2.png'
            if self.symbol == '+4':
                return f'C:\\Users\\Balarubinan\\PycharmProjects\\UNO_game\\src\\UNO_cards\\UNO{z}+4.png'
            if self.symbol == 'skip':
                return f'C:\\Users\\Balarubinan\\PycharmProjects\\UNO_game\\src\\UNO_cards\\UNO{z}{self.color}skip.png'
            if self.symbol == 'wild':
                return f'C:\\Users\\Balarubinan\\PycharmProjects\\UNO_game\\src\\UNO_cards\\UNO{z}wild.png'
            if self.symbol == 'rev':
                return f'C:\\Users\\Balarubinan\\PycharmProjects\\UNO_game\\src\\UNO_cards\\UNO{z}{self.color}rev.png'
